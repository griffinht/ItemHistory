...
class ItemEvent implements Listener {
    ...
    public void onEntityPickupItem(EntityPickupItemEvent event) {
        ...
        for (Node<TrackedItem> node : plugin.trackedItemTree.getLeaves()) {
            ...
            if (nodeTrackedItem.getEventInfo().containsKey("savedEntity") && ((SavedEntity) nodeTrackedItem.getEventInfo().get("savedEntity")).getUniqueId() == event.getItem().getUniqueId())
                trackedItemNode = node;
    ...
    public void onPlayerDropItem(PlayerDropItemEvent event) {
        ...
        for (Node<TrackedItem> node : plugin.trackedItemTree.getLeaves()) {
            ...
            if (nodeTrackedItem.getEventInfo().containsKey("savedEntity") && ((SavedEntity) nodeTrackedItem.getEventInfo().get("savedEntity")).getUniqueId().equals(event.getPlayer().getUniqueId()))
                trackedItemNode = node;
            //System.out.println((trackedItemNode==null));
            //System.out.println();
        }
    ...
    public void onItemSpawn(ItemSpawnEvent event) {
        ...
        for (Node<TrackedItem> node : plugin.trackedItemTree.getLeaves()) {
            ...
            if (nodeTrackedItem.getEventInfo().containsKey("linkedItemStack") && ((LinkedItemStack) nodeTrackedItem.getEventInfo().get("linkedItemStack")).getParent().equals(event.getEntity().getItemStack()))
                trackedItemNode = node;
            //System.out.println((trackedItemNode==null));
            //System.out.println();
        }
